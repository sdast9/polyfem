...
**Status 2026-09-15: validated within stated scope.** Stage 1 published
(`1f6f826fa`), stage 2 characterized, stage 3 published in steps
(`f5f59db26`, `4f5acc773`, `fffc722b9`); the required lanes are at their
known baseline — see [the record](rb-12-validation.md). The manifest's schema is
