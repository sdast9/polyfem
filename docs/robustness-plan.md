...
whose numerical reproduction is still required. Of these, **RBR-02 is
implemented (2026-09-20, checked broad-phase counting and named refusals
before any conversion; see the RB-05 record)**; the others' status is in
their sections of the repair plan. The
