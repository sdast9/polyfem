...
| RB-04 | Accepted-step physical accounting and diagnostics | RB-02 inventory; RB-03 supported mappings | [in progress—physical state pairs validated; fixed-coefficient candidate characterized; scene comparison pending](rb-04-validation.md) |
