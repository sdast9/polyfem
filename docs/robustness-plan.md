...
| RB-18 | Quick-block fixes: coefficient law (positive median, relative floor, nonpositive/nonfinite curvature, d̂²-normalized conditioning cap), no-change stall restarts, lagged friction follows trim | RB-02 counterexamples; RB-04/RB-16 stall and lag evidence | [done — `e3fa362e0`](rb-18-quick-fixes.md) |
