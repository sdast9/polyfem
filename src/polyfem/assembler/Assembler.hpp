...
namespace polyfem::assembler
{
	...
	public:
		...
		void set_materials(const std::vector<int> &body_ids, const json &body_params, const Units &units, const std::string &root_path, const std::shared_ptr<utils::MaterialFileCache> &snapshot = nullptr);
