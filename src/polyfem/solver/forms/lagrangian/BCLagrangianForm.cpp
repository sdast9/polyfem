...
namespace polyfem::solver
{
	...
	{
		// Each objective term already carries its own inverse form scale.
		gradv = A_.transpose() * (-L_weight() * (masked_lumped_mass_sqrt_ * lagr_mults_) + A_weight() * (masked_lumped_mass_ * (A_ * x - b_)));
	}
