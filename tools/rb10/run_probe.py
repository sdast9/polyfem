"""Build and run the RB-10 friction probe against an existing build.

Usage: python3 tools/rb10/run_probe.py --build build --output /absolute/fresh/dir

Compiles tools/rb10/friction_probe.cpp with the unit_tests flags/link line of
...
source = Path(__file__).with_name('friction_probe.cpp').resolve()
obj, binary = out / 'friction_probe.o', out / 'friction_probe'
